...
SOURCE_TEXTURE_FILES: dict[int, str] = {
    ...
    TEX_TILE_COMPARATOR_OFF: "comparator_off.png",
    TEX_TILE_COMPARATOR_ON: "comparator_on.png",
    ...
    TEX_TILE_IRON_INGOT: "iron_ingot.png",
    TEX_TILE_GOLD_INGOT: "gold_ingot.png",
    TEX_TILE_DIAMOND: "diamond.png",
    TEX_TILE_WOOD_PICKAXE: "wood_pickaxe.png",
    TEX_TILE_STONE_PICKAXE: "stone_pickaxe.png",
    TEX_TILE_IRON_PICKAXE: "iron_pickaxe.png",
    TEX_TILE_GOLD_PICKAXE: "gold_pickaxe.png",
    TEX_TILE_DIAMOND_PICKAXE: "diamond_pickaxe.png",
    TEX_TILE_WOOD_AXE: "wood_axe.png",
    TEX_TILE_STONE_AXE: "stone_axe.png",
    TEX_TILE_IRON_AXE: "iron_axe.png",
    TEX_TILE_GOLD_AXE: "gold_axe.png",
    TEX_TILE_DIAMOND_AXE: "diamond_axe.png",
...
SOURCE_TILE_ALLOWED_PALETTE: dict[int, tuple[int, ...]] = {
    ...
    TEX_TILE_COMPARATOR_OFF: (PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT, PAL_BRICK_DARK, PAL_RED),
    TEX_TILE_COMPARATOR_ON: (PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT, PAL_RED, PAL_LAVA_ORANGE, PAL_LAVA_HOT),
    ...
    TEX_TILE_IRON_INGOT: (PAL_UI_DARK, PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT, PAL_WHITE),
    TEX_TILE_GOLD_INGOT: (PAL_UI_DARK, PAL_LAMP_GLOW, PAL_YELLOW, PAL_SUN_CORE, PAL_WHITE),
    TEX_TILE_DIAMOND: (PAL_UI_DARK, PAL_BLUE, PAL_GLASS, PAL_GLASS_HIGHLIGHT, PAL_WHITE),
    TEX_TILE_WOOD_PICKAXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_WOOD_TOP),
    TEX_TILE_STONE_PICKAXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT),
    TEX_TILE_IRON_PICKAXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT, PAL_WHITE),
    TEX_TILE_GOLD_PICKAXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_LAMP_GLOW, PAL_YELLOW, PAL_SUN_CORE, PAL_WHITE),
    TEX_TILE_DIAMOND_PICKAXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_BLUE, PAL_GLASS, PAL_GLASS_HIGHLIGHT, PAL_WHITE),
    TEX_TILE_WOOD_AXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_WOOD_TOP),
    TEX_TILE_STONE_AXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT),
    TEX_TILE_IRON_AXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_STONE_DARK, PAL_STONE, PAL_STONE_LIGHT, PAL_WHITE),
    TEX_TILE_GOLD_AXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_LAMP_GLOW, PAL_YELLOW, PAL_SUN_CORE, PAL_WHITE),
    TEX_TILE_DIAMOND_AXE: (PAL_UI_DARK, PAL_WOOD_DARK, PAL_WOOD, PAL_BLUE, PAL_GLASS, PAL_GLASS_HIGHLIGHT, PAL_WHITE),
