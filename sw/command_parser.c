...
static const CommandBlockName COMMAND_BLOCK_NAMES[] = {
    ...
    { "lamp_on", BLOCK_LAMP },
    { "button", BLOCK_BUTTON },
    { "pressure_plate", BLOCK_WOOD_PRESSURE_PLATE },
    { "wood_pressure_plate", BLOCK_WOOD_PRESSURE_PLATE },
    { "wooden_pressure_plate", BLOCK_WOOD_PRESSURE_PLATE },
    { "wood_pressure_plate_pressed", BLOCK_WOOD_PRESSURE_PLATE_PRESSED },
    { "wooden_pressure_plate_pressed", BLOCK_WOOD_PRESSURE_PLATE_PRESSED },
    { "pressure_plate_pressed", BLOCK_WOOD_PRESSURE_PLATE_PRESSED },
    { "stone_pressure_plate", BLOCK_STONE_PRESSURE_PLATE },
    { "stone_pressure_plate_pressed", BLOCK_STONE_PRESSURE_PLATE_PRESSED },
    ...
    { "door", BLOCK_DOOR },
    { "cactus", BLOCK_CACTUS },
    { "sugar_cane", BLOCK_SUGAR_CANE },
    { "reeds", BLOCK_SUGAR_CANE },
